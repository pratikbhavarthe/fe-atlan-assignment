...
const TagComponent = ({ TagTitle, TagList, setData, setscroll }) => {
	...
	return (
		<div className="flex flex-col p-1 font-[Helvetica,sans-serif] pb-4 border-b border-[#2f52a0]">
			<p className="font-bold text-xl pl-1">{TagTitle}</p>
			<div className="flex flex-wrap p-1">
				<div className="rounded-lg border hover:bg-[#bfe1db] hover:cursor-pointer hover:border-2 p-1 m-1 border-[#f9c6c0] flex flex-row items-center group">
					<svg
						className="pr-1 "
					...
					<span
						...
						className=" group-hover:text-[#076a53]"
					>
						{TagList[0]}
					</span>
				</div>
